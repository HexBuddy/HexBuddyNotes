...
* [Forensics](cybersecurity-tool/forensics.md)
  ...
  * [YARA](cybersecurity-tool/forensics/yara.md)
...
* [GDB: tutorial for Reverse Engineers](binary-exploitation/gdb-tutorial-for-reverse-engineers.md)
...
* [Linux Kernel Exploitation](binary-exploitation/linux-kernel-exploitation/README.md)
  * [1. Setting Up the Environment](binary-exploitation/linux-kernel-exploitation/setting-up-the-environment.md)
  * [2. Introduction to PEDA and Pwntools](binary-exploitation/linux-kernel-exploitation/introduction-to-peda-and-pwntools.md)
  * [3. Classic Exploitation Technique](binary-exploitation/linux-kernel-exploitation/classic-exploitation-technique.md)
  * [4. Linux Binary Protections](binary-exploitation/linux-kernel-exploitation/linux-binary-protections.md)
  * [5. Bypassing NX with Return Oriented Programming](binary-exploitation/linux-kernel-exploitation/bypassing-nx-with-return-oriented-programming.md)
  * [6. Bypassing NX with Ret2Libc](binary-exploitation/linux-kernel-exploitation/bypassing-nx-with-ret2libc.md)
  * [7. ASLR in Depth](binary-exploitation/linux-kernel-exploitation/aslr-in-depth.md)
  * [8. Bypassing ASLR/NX with Ret2PLT](binary-exploitation/linux-kernel-exploitation/bypassing-aslr-nx-with-ret2plt.md)
  * [9. Bypassing ASLR/NX with GOT Overwrite](binary-exploitation/linux-kernel-exploitation/bypassing-aslr-nx-with-got-overwrite.md)
  * [10. Multi-Stage Exploits](binary-exploitation/linux-kernel-exploitation/multi-stage-exploits.md)
  * [11. Format String Vulnerabilties](binary-exploitation/linux-kernel-exploitation/format-string-vulnerabilties.md)
...
* [Penetration Testing Tools Cheat Sheet](cheat-sheets/penetration-testing-tools-cheat-sheet.md)
* [Active Directory Exploitation Cheat Sheet](cheat-sheets/active-directory-exploitation-cheat-sheet.md)
* [Metasploit Cheat Sheet](cheat-sheets/metasploit-cheat-sheet.md)
* [Nmap Cheat Sheet](cheat-sheets/nmap-cheat-sheet.md)
* [Red Team Cheat sheet](cheat-sheets/red-team-cheat-sheet.md)
